...
@Component({
    selector: 'ad-pane-container',
    styleUrls: ['./ad-pane-container.component.scss'],
    templateUrl: './ad-pane-container.component.html'
})
export class AdPaneContainerComponent implements OnInit {
    @Input('data') data: any;
    ...
    ngOnInit() {
        ...
        if (this.pane.title) {
            componentRef.instance.title = this.pane.title;
        }
    }
